...
public class ShapedProducerTest {
	...
	public void testStrict() {
		...
		ItemStackAssertions.assertSame(ItemStack.of(Material.STONE), result1[0][1], "产物应当是石头");
		ItemStackAssertions.assertSame(ItemStack.of(Material.STONE), result1[1][0], "产物应当是石头");
		ItemStackAssertions.assertSame(ItemStack.of(Material.DIRT, 2), result1[1][1], "产物应当是2个泥土");
		// 测试在原有的产物上继续生产的情况
		...
		ItemStackAssertions.assertSame(ItemStack.of(Material.STONE, 2), result2[0][1], "产物应当是2个石头");
		ItemStackAssertions.assertSame(ItemStack.of(Material.STONE, 2), result2[1][0], "产物应当是2个石头");
		ItemStackAssertions.assertSame(ItemStack.of(Material.DIRT, 4), result2[1][1], "产物应当是4个泥土");
		// 测试在一个产物（即将）到达上限时的情况
		...
		// 测试在一个空位上有产物的情况
		result2[0][0] = ItemStack.of(Material.DIRT);
	...
	public void testNotStrict() {
		...
		ItemStackAssertions.assertSame(ItemStack.of(Material.DIRT, 2), result1[1][1], "产物应当是2个泥土");
		// 测试在一个空位上有产物的情况
		result1[0][0] = ItemStack.of(Material.DIRT);
		var result2 = producer.produce(createCtx(), result1);
		Assertions.assertNotNull(result2, "空位上有产物，但不严格，应当能成功产出");
		ItemStackAssertions.assertSame(ItemStack.of(Material.DIRT), result2[0][0], "空位上的产物应当保留");
		ItemStackAssertions.assertSame(ItemStack.of(Material.STONE, 2), result2[0][1], "产物应当是2个石头");
		ItemStackAssertions.assertSame(ItemStack.of(Material.STONE, 2), result2[1][0], "产物应当是2个石头");
		ItemStackAssertions.assertSame(ItemStack.of(Material.DIRT, 4), result2[1][1], "产物应当是4个泥土");
	}
