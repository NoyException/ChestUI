...
public class ShapedConsumerTest {
	...
	public void testMatch() {
		...
		var input1 = new ItemStack[][]{
				{null, ItemStack.of(Material.GOLD_NUGGET), null}, {ItemStack.of(Material.GOLD_NUGGET),
						ItemStack.of(Material.GOLD_INGOT, 2), ItemStack.of(Material.GOLD_NUGGET)},
				{null, ItemStack.of(Material.GOLD_NUGGET), null}};
		...
		var input2 = new ItemStack[][]{{null, null, null, null, null},
				{null, null, ItemStack.of(Material.GOLD_NUGGET), null, null},
				{null, ItemStack.of(Material.GOLD_NUGGET), ItemStack.of(Material.GOLD_INGOT, 2),
						ItemStack.of(Material.GOLD_NUGGET), null},
				{null, null, ItemStack.of(Material.GOLD_NUGGET), null, null}, {null, null, null, null, null}};
	...
	public void testSurplusIngredient() {
		...
		var input1 = new ItemStack[][]{
				{null, ItemStack.of(Material.GOLD_NUGGET), null}, {ItemStack.of(Material.GOLD_NUGGET),
						ItemStack.of(Material.GOLD_INGOT, 3), ItemStack.of(Material.GOLD_NUGGET)},
				{null, ItemStack.of(Material.GOLD_NUGGET), null}};
		var remaining = consumer.consume(createCtx(), input1);
		Assertions.assertNotNull(remaining, "原料匹配，应当能消耗成功");
		ItemStackAssertions.assertSame(ItemStack.of(Material.GOLD_INGOT), remaining[1][1], "消耗后应当还有剩余");
		ItemStackAssertions.assertEmpty(remaining[0][1], "其他位置应当没有剩余");
		// 位置不在左上角（大小拓宽到5*5）
		var input2 = new ItemStack[][]{{null, null, null, null, null},
				{null, null, ItemStack.of(Material.GOLD_NUGGET), null, null},
				{null, ItemStack.of(Material.GOLD_NUGGET), ItemStack.of(Material.GOLD_INGOT, 3),
						ItemStack.of(Material.GOLD_NUGGET), null},
				{null, null, ItemStack.of(Material.GOLD_NUGGET), null, null}, {null, null, null, null, null}};
		remaining = consumer.consume(createCtx(), input2);
		Assertions.assertNotNull(remaining, "原料匹配，应当能消耗成功");
		ItemStackAssertions.assertSame(ItemStack.of(Material.GOLD_INGOT), remaining[2][2], "消耗后应当还有剩余");
	...
	public void testExtraIngredient() {
		...
		var consumer1 = ShapedConsumer.builder().strict(true).pattern(" A ", "ABA", " A ")
				.set('A', new ExactIngredient(Material.GOLD_NUGGET))
				.set('B', new ExactIngredient(Material.GOLD_INGOT, 2)).build();
		var input = new ItemStack[][]{{null, ItemStack.of(Material.GOLD_NUGGET), null},
				{ItemStack.of(Material.GOLD_NUGGET), ItemStack.of(Material.GOLD_INGOT, 2),
						ItemStack.of(Material.GOLD_NUGGET)},
				{null, ItemStack.of(Material.GOLD_NUGGET), ItemStack.of(Material.GOLD_NUGGET)}};
		...
		ItemStackAssertions.assertSame(ItemStack.of(Material.GOLD_NUGGET), remaining[2][2], "空格位置的原料不应被消耗");
	}
	...
	public void testMissingIngredient() {
		var consumer = ShapedConsumer.builder().strict(true).pattern(" A ", "ABA", " A ")
				.set('A', new ExactIngredient(Material.GOLD_NUGGET))
				.set('B', new ExactIngredient(Material.GOLD_INGOT, 2)).build();
		var input = new ItemStack[][]{{null, null, null}, {ItemStack.of(Material.GOLD_NUGGET),
				ItemStack.of(Material.GOLD_INGOT, 1), ItemStack.of(Material.GOLD_NUGGET)},
				{null, ItemStack.of(Material.GOLD_NUGGET), null}};
	...
	public void testWrongIngredient() {
		...
		var input2 = new ItemStack[][]{
				{null, ItemStack.of(Material.GOLD_NUGGET), null}, {ItemStack.of(Material.GOLD_NUGGET),
						ItemStack.of(Material.GOLD_BLOCK, 2), ItemStack.of(Material.GOLD_NUGGET)},
				{null, ItemStack.of(Material.GOLD_NUGGET), null}};
		remaining = consumer.consume(createCtx(), input2);
		Assertions.assertNull(remaining, "原料不符，应当消耗失败");
	}
