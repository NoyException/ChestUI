...
public class ShapelessProducerTest {
	...
	public void testStrict() {
		...
		Assertions.assertTrue(ItemStacks.isSame(new ItemStack(Material.STONE), result1[0][0]), "产物应当是石头");
		Assertions.assertTrue(ItemStacks.isSame(new ItemStack(Material.DIRT, 2), result1[0][1]), "产物应当是2个泥土");
		Assertions.assertTrue(ItemStacks.isEmpty(result1[1][0]), "应当没有产物");
		Assertions.assertTrue(ItemStacks.isEmpty(result1[1][1]), "应当没有产物");
		// 测试在空位有物品的情况
		var output2 = new ItemStack[][]{{null, null}, {null, new ItemStack(Material.STONE)}};
	...
	public void testNotStrict() {
		...
		Assertions.assertTrue(ItemStacks.isSame(new ItemStack(Material.STONE, 2), result2[0][0]), "产物应当是2个石头");
		Assertions.assertTrue(ItemStacks.isSame(new ItemStack(Material.DIRT, 4), result2[0][1]), "产物应当是4个泥土");
		...
		Assertions.assertTrue(ItemStacks.isSame(new ItemStack(Material.STONE, 3), result3[0][0]), "产物应当是3个石头");
		Assertions.assertTrue(ItemStacks.isSame(new ItemStack(Material.DIRT, 64), result3[0][1]), "产物应当是64个泥土");
		Assertions.assertTrue(ItemStacks.isSame(new ItemStack(Material.DIRT, 1), result3[1][0]), "产物应当是1个泥土");
		Assertions.assertTrue(ItemStacks.isEmpty(result3[1][1]), "应当没有产物");
		// 测试再溢出时位置不够的情况
		result3[0][0].setAmount(64);
		result3[1][1] = new ItemStack(Material.DIRT);
