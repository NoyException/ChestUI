...
public class CUIPickItemEvent<T extends ChestUI<T>> extends Event implements Cancellable {
	...
	public CUIPickItemEvent(@NotNull Camera<T> camera, @Nullable Player player, @NotNull Position position,
